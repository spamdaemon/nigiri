...
this.AsyncSpec = (function(global){
  ...
  function AsyncSpec(spec, options){
    this.spec = spec;
  ...
  AsyncSpec.prototype.beforeEach = function(block){
    this.spec.beforeEach(runAsync(block,this.options.timeout));
  };

  AsyncSpec.prototype.afterEach = function(block){
    this.spec.afterEach(runAsync(block,this.options.timeout));
  };
  ...
  AsyncSpec.prototype.it = function(description, block){
    ...
    // context.
    global.it(description, runAsync(block,this.options.timeout));
  };
