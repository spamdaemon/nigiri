zone("nigiri").protectedFactory("MyTransaction", [ "MyDBEventTarget","MyObjectStore","addEventHandlerProperty","Utils" ], function(MyDBEventTarget,MyObjectStore,addEventHandlerProperty,Utils) {
